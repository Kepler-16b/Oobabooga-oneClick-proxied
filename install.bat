...
set MICROMAMBA_DOWNLOAD_URL=https://ghproxy.com/https://github.com/mamba-org/micromamba-releases/releases/download/1.4.0-0/micromamba-win-64
set REPO_URL=https://ghproxy.com/https://github.com/oobabooga/text-generation-webui.git
set umamba_exists=F
...
if exist text-generation-webui\ (
  ...
  git clone https://ghproxy.com/https://github.com/oobabooga/text-generation-webui.git
  call python -m pip install https://ghproxy.com/https://github.com/jllllll/bitsandbytes-windows-webui/raw/main/bitsandbytes-0.37.2-py3-none-any.whl
...
if not exist GPTQ-for-LLaMa\ (
  ...
  if not exist "%INSTALL_ENV_DIR%\lib\site-packages\quant_cuda-0.0.0-py3.10-win-amd64.egg" (
    ...
    call python -m pip install https://ghproxy.com/https://github.com/jllllll/GPTQ-for-LLaMa-Wheels/raw/main/quant_cuda-0.0.0-cp310-cp310-win_amd64.whl || ( echo. && echo Wheel installation failed. && goto end )
  )
)
